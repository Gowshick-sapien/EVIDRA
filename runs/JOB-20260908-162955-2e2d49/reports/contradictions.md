...
- **Decision ID:** `DEC-7990623d`
- **Verdict:** `CONTRADICTION`
- **Decision Strength:** `HIGH`
- **Reasoning:** Conflicting claim clusters identified: [-4.56 UNIT_BASE (1 sources), -5.67 UNIT_BASE (1 sources), -1.98 UNIT_BASE (1 sources)]. Direct numerical variance without reconciling disclosure.
